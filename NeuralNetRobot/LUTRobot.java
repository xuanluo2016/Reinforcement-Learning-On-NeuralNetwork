...
public class LUTRobot extends AdvancedRobot implements LUTInterface {
		...
		public static int totalRounds = 2000; // number of rounds	
		...
		public static double epsilon = 0.05;// the epsilon in epsilon greedy 
		...
		public void saveWinRate2(File argFile) {
			...
			for (int i = 0; i<N2; i++){
				...
				for (int j=0; j<numforoneRound;j++) {
			       totalWins2 = totalWins2 + winHistory[j+i*numforoneRound+threshold];
				}
